    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddMongoDatabase()
                    ...
                    .AddMongoRepository<Entity.OrderHistory>("orderhistory");
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "MSPOC.Customer.Service", Version = "v1" });
            });
        }
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseSwagger();
            app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "MSPOC.Customer.Service v1"));
